...
import Enhanced from "../../components/rfid/enhanced";
import InvoicingPricing from "../../components/rfid/InvoicingPricing";
import Connect from "../../components/rfid/connect";
...
export async function getStaticProps() {
  const data = await import("./rfid-home.json");
  return {
    props: {
