...
import { aspectbussinessdata } from "../retail-comman/Helper";
    ...
    <section id="apps">
      <div className="container mx-auto mt-16 sm:mt-[80px] 3xl:mt-[89px]" >
        ...
        <div className="justify-center flex mt-3 mx-2 sm:mx-0">
          ...
          Our comprehensive suite of retail-focused applications includes POS, Sales, Inventory, and more. Each app is designed to work independently or in harmony with the others to simplify your retail management needs
          </p>
        </div>
      </div>
