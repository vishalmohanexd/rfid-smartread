    ...
    <div>
      <div className="container mx-auto px-3">
        <div className="flex justify-center">
          <h1 className="font-Inter text-[#101828] font-bold sm:mx-0 mx-[5px] leading-[42px] sm:leading-[50px] md:leading-[70px]  mt-[50px] sm:mt-[90px] max-w-[350px] sm:max-w-[700px]  text-center text-2xl md:text-[48px]">
            RFID Connect <br /> The Future of Retail
          </h1>
        </div>
        <div className="flex justify-center mt-[17px] sm:mt-[34px]">
          <p className="font-Inter font-normal text-sm sm:text-md max-w-[755px] text-center text-lightgrey ">
            Designed to redefine retail operations, RFID Connect leverages the
            power of Radio-Frequency Identification (RFID) to bring you a host
