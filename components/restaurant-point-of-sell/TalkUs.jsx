...
const TalkUs = (pageName) => {
  ...
  return (
    <>
    {!visible&&(
    <div className="bg-greyshade1 py-8 sm:py-12">
      <div className="container flex flex-col lg:flex-row justify-between items-center px-3 mx-auto">
        <div className="w-full lg:w-[60%] ">
          <div className="flex justify-center flex-col">
            ...
            <p className="font-normal mt-[12px] sm:mt-5 text-center lg:text-start  text-sm sm:text-md  text-lightgrey ff-inter max-w-[702px]">
              We are here to assist you with any issues or queries you may have
            </p>
            <div className="w-full lg:w-[35%]">
          {" "}
          <div className="mt-[15px] lg:mt-0  flex justify-center lg:justify-start  lg:hidden">
            <Image
              src="/images/talk-us-1.webp"
              width={526}
              height={610}
              alt="talk us img"
            />
        ...
        <div className="w-full lg:w-[35%]">
          {" "}
          <div className="mt-[15px] lg:mt-0  flex justify-center lg:justify-start hidden lg:block">
            <Image
              src="/images/talk-us-1.webp"
              width={526}
              height={610}
