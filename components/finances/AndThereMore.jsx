...
import { andThereMoresData } from "../common/Helper";
import { BarcodeScannerIcon } from "../common/Icons";

const AndThereMore = () => {
    return (
        <div>
            <div className="max-w-[1120px] mx-auto px-3 xl:px-0 sm:mt-[70px] mt-[40px] md:mt-[100px] lg:mt-[150px] ">
                <div className="flex flex-col lg:flex-row justify-between items-start">
                    <div className="max-w-[600px] mx-auto lg:mx-0 lg:max-w-[500px] w-full">
                        ...
                        <p className="text-sm sm:text-lg text-center lg:text-start  font-normal sm:mt-[23px] mt-[15px] text-lightgrey leading-[22px] sm:leading-[32px]">
                            Checkout several other features that can help businesses to optimize Financial operations
                        </p>
                        <div className="max-w-[550px] mx-auto lg:mx-0 mt-9 lg:mt-0 lg:pl-2 xl:pl-0 w-full lg:hidden">
                        <Image src="/images/and-there-more-img-4.png" width={623} height={725} alt="and there more img" />
                    </div>
                        <div>
                            {andThereMoresData.map((item, index) => (
                                <div
                                    key={index}
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-center sm:text-start font-normal text-lightgrey mt-[14px]">{item.desc}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
