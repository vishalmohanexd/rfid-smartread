    ...
    <section id="apps">
      <div className="container mx-auto mt-16 sm:mt-[80px] 3xl:mt-[89px]">
        ...
        <div className="justify-center flex mt-3 mx-2 sm:mx-0">
          ...
          From POS and Sales to Inventory and Purchase, we offer an array of restaurant-centric apps that enhance operational efficiency, maximize profitability, and help restaurants deliver exceptional experiences
          </p>
        </div>
      </div>
