      ...
      <div className="z-20 top-[38px] w-[240px] absolute left-0 flex flex-col xl:flex-row py-3 bg-white shadow rounded">
        <ul className="flex flex-col items-start w-full ff-Inter">
          <li className="footer-text   text-[101828] hover:bg-[#D9D9D9] w-full px-4 py-2 cursor-pointer">
            <Link
              href={"/smart-reads/rfid-connect/apps/check-out-basket"}
          ...
          <li className="footer-text  text-[101828] hover:bg-[#D9D9D9] w-full px-4 py-2 cursor-pointer">
            <Link
              href={"/smart-reads/rfid-connect/apps/eas-gates"}
              className="w-full inline-block"
            >
              {" "}
              Services
          ...
          <li className="footer-text  text-[101828] hover:bg-[#D9D9D9] w-full px-4 py-2 cursor-pointer">
            <Link
              href={"/smart-reads/rfid-connect/apps/smart-tray"}
              className="w-full inline-block"
            >
              {" "}
              Training & Support
          ...
          <li className="footer-text  text-[101828] hover:bg-[#D9D9D9] w-full px-4 py-2 cursor-pointer">
            <Link
              href={"/smart-reads/rfid-connect/apps/smart-fitting-room"}
              className="w-full inline-block"
            >
              Consulting
            </Link>
          ...
          <li className="footer-text  text-[101828] hover:bg-[#D9D9D9] w-full px-4 py-2 cursor-pointer">
            <Link
              href={"/smart-reads/rfid-connect/apps/smart-trolley"}
              className="w-full inline-block"
            >
              ERP Integrations
            </Link>
